...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"C:\Users\Sarvesh Kumar\Desktop\detection\Images_GUI\hh.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\Sarvesh Kumar\Desktop\detection\Images_GUI\bg4.png")
        ...
        title_lb2 = Label(bg_img,text="For More Support Email: arun739singh@gmail.com",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb2.place(x=0,y=500,width=1366,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\Sarvesh Kumar\Desktop\detection\Images_GUI\web.png")
        ...
        # det_img_btn=Image.open(r"C:\Users\Sarvesh Kumar\Desktop\detection\Images_GUI\fb.png")
        ...
        att_img_btn=Image.open(r"C:\Users\Sarvesh Kumar\Desktop\detection\Images_GUI\yt.png")
        ...
        att_b1.place(x=620,y=200,width=180,height=180)

        att_b1_1 = Button(bg_img,command=self.youtube,text="Youtube",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        att_b1_1.place(x=620,y=380,width=180,height=45)

         # Help  Support  button 4
        hlp_img_btn=Image.open(r"C:\Users\Sarvesh Kumar\Desktop\detection\Images_GUI\gmail.png")
    ...
    def youtube(self):
        self.new = 1
        self.url = "https://youtu.be/z3aYU5yOyp0?si=ublyO4JQBIAAb7HF"
        webbrowser.open(self.url,new=self.new)
