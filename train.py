...
class Train:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\Sarvesh Kumar\Desktop\detection\Images_GUI\data train.jpeg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        # std_img_btn=Image.open(r"C:\Users\Sarvesh Kumar\Desktop\detection\Images_GUI\t_btn1.png")
        ...
        std_b1_1.place(x=600,y=680,width=180,height=45)
