...
# This part is image labels setting start 
        ...
        # set image as lable.LANCZOS.LANCZOS
        f_lb1 = Label(self.root,image=self.photoimg)
        f_lb1.place(x=0,y=0,width=1366,height=130)

        # backgorund image 
        bg1=Image.open(r"C:\Users\Sarvesh Kumar\Desktop\detection\Images_GUI\c.jpg")
        ...
        img5=Image.open(r"C:\Users\Sarvesh Kumar\Desktop\face\images\p.jpg")
